...
const STEPS: Step[] = [
  ...
  { icon: UserCircle2, title: 'Individual Computational Profile', detail: 'Identity lookup and learned parameters', branch: 'identity' },
  ...
  { icon: BrainCircuit, title: 'Virtual brain state generator', detail: 'Profile and task combine here', branch: 'merge' },
  { icon: Network, title: 'Neural pathways', detail: 'Candidate virtual systems activate' },
  { icon: FlaskConical, title: 'Neurotransmitter and hormone layer', detail: 'Simulated neuromodulation/endocrine signals' },
  { icon: Activity, title: 'Cognitive state', detail: 'Assembled state passed to the model' },
  { icon: ShieldCheck, title: 'Verification', detail: 'Self-consistency and self-verification when warranted' },
